...
message = "no_message"
flag2 = False
client = Client("AC67909901f0623582ce6f570506d4a2bb", "e53ccbbe5d38144ec7b807d2d5dc275b")
...
def sendmail(img_no):
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
        smtp.login(' ', ' ')     # senders mail add and pass to login
        ...
        if cv2.contourArea(contour) < 22000:
            ...
            if flag_for_taking_ss == 0 and counter > 20:
                ...
                call = client.calls.create(
                     ...
                     from_="+12763859640", to='+917820866043')
                image_no += 1
                flag = 1
                while True:
